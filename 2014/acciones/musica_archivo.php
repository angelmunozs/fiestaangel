		...
		if (((in_array($extension, $allowedExts))||($_FILES["file"]["type"] == "audio/mp3"))&& ($_FILES["file"]["size"] < 5000000)) {
			if ($_FILES["file"]["error"] > 0) {
				...
				if (file_exists("../flashmp3player/mp3/" . $cancionSEO)) {
					...
					$insertar = "INSERT INTO 2014_07_19_canciones(usuario, artista, titulo, archivo, link, sent) VALUES ('$usuariocancion', '$elartista', '$lacancion', '$cancionSEO', '$linkNulo', '$fecha')";
