...
if($_SESSION["online"] != "1"){
	...
	// Si ya se ha hecho...
		...
		$eliminaanterior = "DELETE FROM 2014_07_19_encuesta WHERE usuario='$usuarioencuesta'";
		mysql_query($eliminaanterior);
		$cambiaencuesta = "UPDATE 2014_07_19_invitados SET encuesta=0 WHERE usuario='$usuarioencuesta'";
