...
if($_SESSION["online"] != "1"){
	...
	if(!$elNombre||!$elApellido||!$elPassword){
		...
		$query = 'SELECT * FROM 2014_07_19_invitados'; 
		...
		if($existe_invitado!=0){
			...
			$query = mysql_query("INSERT INTO 2014_07_19_invitados (usuario, password, nombre, apellido) VALUES ('$elUsuario','$elPassword','$elNombre', '$elApellido')") or die(mysql_error());
