...
if($_SESSION["online"] != "1"){
	...
	if (!$_POST["artista"]||!$_POST["cancion"]||!$_POST["link"]) {
		...
		$insertar = "INSERT INTO 2015_07_10_canciones(usuario, artista, titulo, archivo, link, sent) VALUES ('$usuariocancion', '$elartista', '$lacancion', '$cancionSEOnulo', '$elLink', '$fecha')";
