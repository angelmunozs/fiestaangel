...
if($_SESSION["online"] != "1"){
	...
	if(!$elUsuario){
		...
		$query = mysql_query("SELECT * FROM 2015_07_10_invitados WHERE usuario = '".$elUsuario."'") or die(mysql_error());
		...
		// Si ya se ha hecho...
			...
			$eliminaanterior = "DELETE FROM 2015_07_10_encuesta WHERE usuario='$elUsuario'";
			mysql_query($eliminaanterior);
			$cambiaencuesta = "UPDATE 2015_07_10_invitados SET encuesta=0 WHERE usuario='$elUsuario'";
