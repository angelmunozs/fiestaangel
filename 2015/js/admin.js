...
function mostrarTodasLasCanciones(){
	if(cde%2==0){
		...
		document.getElementById('tabla2015_07_10_canciones0Ultimas').style.display = "none";
		...
		document.getElementById('tabla2015_07_10_canciones0Ultimas').style.display = "table";
	}
	cde=cde+1;
}
