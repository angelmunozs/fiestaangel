    ...
    <table id="tablainfo" cellpadding="0px" cellspacing="10px" align="center" width="100%">
    	<tr>
        	<td width="20%" align="center" style="background-color:rgba(0, 0, 0, 0.7);padding-top:5px" valign="top">
                ...
                <div style="background-color:rgba(0, 0, 0, 0.7);border-radius:25px;padding-bottom:10px;margin-left:10%;margin-right:10%;margin-bottom:17px;">
            	...
            	<div align="center" style="color:#fff;font-family:'."'PT Sans Narrow'".';font-size:24px;padding:8px;">Planning</div>
                    <div id="contenidoinfo" align="left">
                        <ul style="color:#fff;font-family:'."'Open Sans Condensed'".';margin-left:15px;font-size:18px;">
                            <li>El <span style="color:#2E9AFE">alcohol</span>, los <span style="color:#2E9AFE">vasos</span> y los <span style="color:#2E9AFE">hielos</span> los traéis vosotros.</li>
                            ...
                            <li>Traed <span style="color:#2E9AFE">bañador.</span> Habrá piscina.</li>
                            <li>La <span style="color:#2E9AFE">música</span> será variada, y podéis traer caniones en un pen-drive o mandármelas a través de esta página para ponerlas en la fiesta, pero a los altavoces NO se podrán conectar móviles ni otro tipo de reproductores.</li>
                            <li>La única <span style="color:#2E9AFE">entrada</span> y <span style="color:#2E9AFE">salida</span> a la casa será la pista de tennis.</li>
                        </ul>
                    </div>
            	...
            	<tr>
                    ...
                    <div id="contenidonormascross" align="left">
                        <ul>
                            ...
                            <li>Armar mucho jaleo fuera (por los vecinos).</li>
                    ...
                    <div id="contenidonormastick" align="left">
                        <ul>
                            ...
                            <li>Dormir en el coche o en una tienda de campaña.</li>
                    ...
                    <tr>
                        ...
                        <div id="contenidonormascross" align="left">
                            <ul>
                                ...
                                <div align="left" style="color:#999; font-size:20px;margin-top:0px;padding-top:0px;padding-bottom:13px;">Parada: <span style="color:#fff;font-size:17px;"> La última de todas</span></div>
                                    ...
                                    <a href="http://www.crtm.es/datos_lineas/horarios/8518H1.pdf" target="_blank">
                                    Descargar horarios de ida.
                                    </a>
                                    </div>
                                    <div align="right" id="descargarhorarios" style="font-size:14px;margin-top:0px;padding-top:0px;">
                                    <a href="http://www.crtm.es/datos_lineas/horarios/8518H2.pdf" target="_blank">
                        ...
                        <div id="contenidonormascross" align="left">
                            <ul>
                                ...
                                <div align="left" style="color:#999; font-size:20px;margin-top:0px;padding-top:0px;padding-bottom:13px;">Parada: <span style="color:#fff;font-size:17px;"> La última de todas</span></div>
                                    <div align="right" id="descargarhorarios" style="font-size:14px;margin-top:0px;padding-top:0px;">
                                    <a href="http://www.crtm.es/datos_lineas/horarios/8N504H1.pdf" target="_blank">
                                    Descargar horarios de ida.
                                    </a>
                                    </div>
                                    <div align="right" id="descargarhorarios" style="font-size:14px;margin-top:0px;padding-top:0px;">
                                    <a href="http://www.crtm.es/datos_lineas/horarios/8N504H2.pdf" target="_blank">
                                    Descargar horarios de vuelta.
                                    </a>
                                    </div>
                            </ul>
...
<div id="solomovil" style="display:none;">
    ...
    <table id="tablainfo" cellpadding="0px" cellspacing="10px" align="center" width="100%">
    	<tr>
        	<td width="33%" align="center" style="background-color:rgba(0, 0, 0, 0.7);padding-top:5px" valign="top">
                <div style="background-color:rgba(0, 0, 0, 0.7);border-radius:33px;padding-bottom:10px;margin-left:10%;margin-right:10%;margin-bottom:12px;">
                    <img src="imagenes/titulofecha.png" alt="" /><br />
                    <img src="imagenes/fecha.png" alt="" /><br />
                </div>
            </td>
